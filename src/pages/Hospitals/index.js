...
import {DummyHospital1, DummyHospital2, ILHospitalBG, DummyHospital3} from '../../assets';
  ...
  return (
    <View style={styles.page}>
      ...
      <View style={styles.content}>
        ...
        <ListHospital type="Rumah Sakit Anak" name="Happy Family and Kids" address="Jln. Surya Sejahtera 20" pic={DummyHospital2} />
